...
public:
	...
	static const Vector3f FORWARD;
		// when instance of Vector3f object is created as such:
		// Vector3f name;
		// ... then here that default value is assigned to 0 0 0:
	...
	static float distance( const Vector3f& v0, const Vector3f& v1 );
